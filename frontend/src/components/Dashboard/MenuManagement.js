    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className={`flex items-center px-4 py-2 rounded-lg ${isDarkMode ? 'bg-yellow-500 text-gray-900 hover:bg-yellow-400' : 'bg-yellow-500 text-gray-900 hover:bg-yellow-600'} transition-colors`}
        >
