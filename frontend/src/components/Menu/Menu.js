      ...
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600 relative sm:static fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[90vw] max-w-xs sm:max-w-none sm:w-auto z-40 shadow-lg sm:shadow-none"
            style={{ display: 'block' }}
          >
